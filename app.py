from service.serving import prediction_precedure, production_model_procedure, create_data, train_precedure
...
def main():
    ...
    parser.add_option("--forecast", action="store_true")
